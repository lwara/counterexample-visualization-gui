...
class ProcessUclidResults:
    ...
    def get_CEX(self, json_uclid5_result, file_path):
        ...
        for section in sections:             
            ...
            step_number = int(cex_info.split()[0]) # this and line number qre getting the line where the counter example failed
            ...
            matched_line_number = match.group() if match else None  # Get the matched number
                    ...
                    if f"Step #{step_checker}".strip() in sub_section :
                        ...
                        if matched_step: # this section is ambiguous 
                           ...
                           # steps.append((f"CEX for f {cex_header}", sub_section, matched_line_number))    
                            ...
                            step_checker += 1
                steps.append((f"CEX for f {cex_header}", assertion_code, step_assertions)) 
                #print(step_assertions)
                step_assertions =[]            
                #serial_number =1
                step_checker = 0
